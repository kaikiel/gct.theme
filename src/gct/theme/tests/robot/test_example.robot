...
#
#  $ bin/test -s gct.theme -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src gct.theme.testing.GCT_THEME_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/gct/theme/tests/robot/test_example.robot
#
